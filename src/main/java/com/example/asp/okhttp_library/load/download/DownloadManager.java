...
import com.example.asp.okhttp_library.load.task.ExecutorWithListener;
...
public class DownloadManager {
    ...
    private void addTask(@NonNull String url, DownloadListener listener, boolean isRestart) {
        ...
        if (downloadInfo.getState() == DownloadManager.NONE //
            ...
            //构造即开始执行
            DownloadTask downloadTask = new DownloadTask(downloadInfo, mContext, isRestart, listener);//构造函数的初始化。会先执行父类的构造函数
