package com.example.asp.okhttp_library.load.download;
...
import com.example.asp.okhttp_library.load.L;
import com.example.asp.okhttp_library.load.listener.DownloadListener;
import com.example.asp.okhttp_library.load.task.PriorityAsyncTask;
...
public class DownloadTask extends PriorityAsyncTask<Void, DownloadInfo, DownloadInfo> {
 ...
 /*           mDownloadInfo.setNetworkSpeed(0);
            ...
            Log.d("lixuan","file --- startpos:  "+startPos);
        } else {
            //断点下载的情况
            startPos = mDownloadInfo.getDownloadLength();
            Log.d("lixuan","startpos:  "+startPos);
        }
        ...
        //获取流对象，准备进行读写文件
        long totalLength = response.body().contentLength();//获取下载文件的长度
    ...
    private final class ProgressRandomAccessFile extends RandomAccessFile {
        ...
        public void write(byte[] buffer, int offset, int count) throws IOException {
            ...
            Log.d("lixuan","downloadLength:   "+downloadLength);
